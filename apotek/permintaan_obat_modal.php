...
<div class="modal fade bd-example-modal-lg" id="konfirmasi<?= $d['id_permintaan_obat']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Konfirmasi Obat Masuk</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="jumlah_permintaan_obat" value="<?= $d['jumlah_permintaan_obat'] ?>" class="form-control">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="status_permintaan_obat" id="" class="form-control">
                                ...
                                <option value="diterima apotek">Diterima Apotek</option>
