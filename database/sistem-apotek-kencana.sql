...
--
-- Host: localhost
-- Generation Time: Aug 21, 2024 at 12:35 AM
...
(9, 'Amoksisilin', 'Botol', 100, 3),
(10, 'Ciprofloxacin', 'Botol', 0, 3),
...
CREATE TABLE `tb_obat_masuk` (
  ...
  `status_terjual` varchar(20) NOT NULL,
...
INSERT INTO `tb_obat_masuk` (`id_obat_masuk`, `kode_transaksi`, `tgl_obat_masuk`, `id_obat`, `jumlah_obat`, `tgl_kadaluarsa`, `keterangan`, `status_terjual`, `id_rak`) VALUES
(38, 'BM-20240820-0001', '20-08-2024', 9, '100', '31-08-2024', 'test2', 'Belum Terjual', 2);
...
--
ALTER TABLE `tb_obat_masuk`
  MODIFY `id_obat_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
