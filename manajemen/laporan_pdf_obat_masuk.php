                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <a href="laporan_pdf_full.php" class="btn btn-primary btn-sm"><i data-feather="plus"></i> Download Full Rekap</a><br><br>
                                    <tr>
                                        <form action="laporan_pdf_bulanan.php" method="post">
                                        <td>
                                            Bulan
                                    ...
                                    <tr>
                                        <form action="laporan_pdf_tahunan.php" method="post">
                                        <td>
                                            Tahun
